...
class Article
{
  ...
  public function __construct($data=array()) {
    ...
    if(isset($data['title'])) $this->title=preg_replace("/[^\.\,\-\_\'\"\@\?\!\:\$\sa-zA-Z0-9А-Яа-я()]/u", "", $data['title']);
    if(isset($data['summary'])) $this->summary=preg_replace("/[^\.\,\-\_\'\"\@\?\!\:\$\sa-zA-Z0-9А-Яа-я()]/u", "", $data['summary']);
    if(isset($data['content'])) $this->content=preg_replace("/[^\.\,\-\_\'\"\@\?\!\:\$\sa-zA-Z0-9А-Яа-я()]/u", "", $data['content']);
  }
